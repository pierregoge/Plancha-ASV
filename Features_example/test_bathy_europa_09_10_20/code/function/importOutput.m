function output = importOutput(filename, startRow, endRow)
...
%
% Example:
%   output = importfile('output.log', 2, 18408);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2022/02/04 14:59:46
